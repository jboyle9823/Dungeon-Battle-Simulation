 ...
 * Description: The Healer class that extends from the Adventurer class.
...
class Healer extends Adventurer {
    /**
     * General constructor for the Healer object with name, atk, hp, lck and input.
     *
     ...
     */
    public Healer(String name, int atk, int hp, int lck, SimulationInput input) {
     ...
     * @param input The simulation input object for the adventurer object.
     */
    public Healer(SimulationInput input) {
        super(input);
    }
    ...
    public int uniqueSkill() {
        System.out.println("    >Healer uses unique skill Heal.");
        return 4;
    }
}
